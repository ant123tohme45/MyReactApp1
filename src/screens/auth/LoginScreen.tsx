...
const backgroundImage = require('../../mobile-phone-1087845_1280.webp');
...
const LoginScreen = () => {
  ...
  return (
    <SafeAreaView style={dynamicStyles.safeArea} edges={['top']}>
       <ImageBackground
    source={backgroundImage} // adjust path based on your structure
  ...
  >
      ...
      <KeyboardAvoidingView
        ...
        <ScrollView contentContainerStyle={dynamicStyles.content}>
          <Text style={dynamicStyles.title}>Welcome To Our Store</Text>
          ...
          <View style={dynamicStyles.linkContainer}>
            <TouchableOpacity
              ...
              <Text style={dynamicStyles.linkText}>
                Don't have an account? We can Help YOU ={'>'} Sign up
              </Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
